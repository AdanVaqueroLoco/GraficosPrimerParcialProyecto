...
activos_enemigos2 = [1,1,0]
vivos_enemigos2 = [True, True, True]
...
activos_enemigos3 = [1,0,1]
vivos_enemigos3 = [True, True, True]
...
vivos_enemigos4 = [True, True, True]
...
activos_enemigos5 = [1,1,0]
vivos_enemigos5 = [True, True, True]
    ...
    for i in range(3):
        if activos_enemigos[i]:
            ...
            if direcciones_enemigos[i] == 0:
                ...
                posiciones_enemigos[i][0] = posiciones_enemigos[i][0] + (cantidad_movimiento*5)
                posiciones_enemigos[i][1] = posiciones_enemigos[i][1] - (cantidad_movimiento/2)
                if posiciones_enemigos[i][0] >= 0.75:
    ...
    for i in range(3):
        if activos_enemigos2[i]:
            ...
            if direcciones_enemigos2[i] == 0:
                ...
                posiciones_enemigos2[i][0] = posiciones_enemigos2[i][0] + cantidad_movimiento
                posiciones_enemigos2[i][1] = posiciones_enemigos2[i][1] - (cantidad_movimiento/6)
                if posiciones_enemigos2[i][0] >= 0.75:
    ...
    for i in range(3):
        if activos_enemigos3[i]:
            ...
            if direcciones_enemigos3[i] == 0:
                ...
                posiciones_enemigos3[i][0] = posiciones_enemigos3[i][0] + cantidad_movimiento
                posiciones_enemigos3[i][1] = posiciones_enemigos3[i][1] - (cantidad_movimiento/8)
                if posiciones_enemigos3[i][0] >= 0.75:
    ...
    for i in range(3):
        if activos_enemigos4[i]:
            ...
            if direcciones_enemigos4[i] == 0:
                ...
                posiciones_enemigos4[i][0] = posiciones_enemigos4[i][0] + cantidad_movimiento
                posiciones_enemigos4[i][1] = posiciones_enemigos4[i][1] - (cantidad_movimiento/10)
                if posiciones_enemigos4[i][0] >= 0.75:
    ...
    for i in range(3):
        if activos_enemigos5[i]:
            ...
            if direcciones_enemigos5[i] == 0:
                ...
                posiciones_enemigos5[i][0] = posiciones_enemigos5[i][0] + cantidad_movimiento
                posiciones_enemigos5[i][1] = posiciones_enemigos5[i][1] - (cantidad_movimiento/17)
                if posiciones_enemigos5[i][0] >= 0.75:
...
def actualizar_bala(tiempo_delta):
    ...
    for i in range(3):
        if disparando:
            ...
            posiciones_bala[0] = posiciones_bala[0] + (
                math.cos(angulo_bala * pi / 180.0) * cantidad_movimiento
            )
            posiciones_bala[1] = posiciones_bala[1] + (
            ...
            if (posiciones_bala[0] > 1 or posiciones_bala[0] < -1 or 
                posiciones_bala[1] > 1 or posiciones_bala[1] < -1):
                disparando = False
...
def actualizar():
    ...
    if estado_tecla_espacio == glfw.PRESS and estado_anterior_espacio == glfw.RELEASE:
        for i in range(3):
            if not disparando:
                disparando = True
                posiciones_bala[0] = posicion_nave[0]
                posiciones_bala[1] = posicion_nave[1]
                angulo_bala = angulo_nave + fase
                break
...
def draw_nave():
    ...
    for i in range(3):
        if colisionando(posicion_nave[0],posicion_nave[1],
            ...
            glColor3f(0,0,1)
            glfw.set_window_should_close(window,True)
        elif colisionando(posiciones_bala[0],posiciones_bala[1],
            0.01,0.01,0.01,0.01,
            posiciones_enemigos[i][0], posiciones_enemigos[i][1],
            0.05,0.05,0.05,0.05):
            posiciones_enemigos[i] = [-1.0, 50.00, 0.0]
            vivo_bala = False
            if vivo_bala == False:
                posiciones_bala = [1.2,1.2,0.0]
            break
        elif colisionando(posiciones_bala[0],posiciones_bala[1],
            0.01,0.01,0.01,0.01,
            posiciones_enemigos2[i][0], posiciones_enemigos2[i][1],
            0.05,0.05,0.05,0.05):
            posiciones_enemigos2[i] = [-10.0, 50.00, 0.0]
            vivo_bala = False
            if vivo_bala == False:
                posiciones_bala = [1.2,1.2,0.0]
            break
            ...
            posiciones_enemigos3[i][0], posiciones_enemigos3[i][1],
            0.05,0.05,0.05,0.05):
            posiciones_enemigos3[i] = [-10.0, 50.00, 0.0]
            vivo_bala = False
            if vivo_bala == False:
                posiciones_bala = [1.2,1.2,0.0]
            break
            ...
            posiciones_enemigos4[i][0], posiciones_enemigos4[i][1],
            0.05,0.05,0.05,0.05):
            posiciones_enemigos4[i] = [-10.0, 50.00, 0.0]
            vivo_bala = False
            if vivo_bala == False:
                posiciones_bala = [1.2,1.2,0.0]
            break
            ...
            posiciones_enemigos5[i][0], posiciones_enemigos5[i][1],
            0.05,0.05,0.05,0.05):
            posiciones_enemigos5[i] = [-10.0, 50.00, 0.0]
            vivo_bala = False
            if vivo_bala == False:
                posiciones_bala = [1.2,1.2,0.0]
            break
            ...
            0.05,0.05,0.05,0.05,
            posicion_borde_izq[0], posicion_borde_izq[1],
            0.05,0.05,0.05,0.05):
            glfw.set_window_should_close(window,True)
            break
        elif colisionando(posicion_nave[0],posicion_nave[1],
            0.05,0.05,0.05,0.05,
            posicion_borde_der[0], posicion_borde_der[1],
            0.05,0.05,0.05,0.05):
            glfw.set_window_should_close(window,True)
            break
...
def draw_bala():
    ...
    if vivo_bala:
        glPushMatrix()
        glTranslatef(posiciones_bala[0], posiciones_bala[1], 0.0)
        glBegin(GL_QUADS)
...
def draw_borde_izq():
    global posicion_borde_izq
    glPushMatrix()
    glTranslatef(posicion_borde_izq[0], posicion_borde_izq[1], 0.0)
    glBegin(GL_QUADS)
    glColor3f(0.0, 0.0, 0.0)
    glVertex3f(-0.05,0.05,0.0)
    glVertex3f(0.05,0.05,0.0)
...
def draw_borde_der():
    global posicion_borde_der
    glPushMatrix()
    glTranslatef(posicion_borde_der[0], posicion_borde_der[1], 0.0)
    glBegin(GL_QUADS)
    glColor3f(0.0, 0.0, 0.0)
    glVertex3f(-0.05,0.05,0.0)
    glVertex3f(0.05,0.05,0.0)

    ...
    for i in range(3):
        if activos_enemigos[i]:
            ...
            if direcciones_enemigos[i] == 0:
                ...
                posiciones_enemigos[i][0] = posiciones_enemigos[i][0] + cantidad_movimiento
                posiciones_enemigos[i][1] = posiciones_enemigos[i][1] - (cantidad_movimiento/12)
                if posiciones_enemigos[i][0] >= 0.75:
    ...
    for i in range(3):
        if activos_enemigos2[i]:
            ...
            if direcciones_enemigos2[i] == 0:
                ...
                posiciones_enemigos2[i][0] = posiciones_enemigos2[i][0] + cantidad_movimiento
                posiciones_enemigos2[i][1] = posiciones_enemigos2[i][1] - (cantidad_movimiento/14)
                if posiciones_enemigos2[i][0] >= 0.75:
    ...
    for i in range(3):
        if activos_enemigos3[i]:
            ...
            if direcciones_enemigos3[i] == 0:
                ...
                posiciones_enemigos3[i][0] = posiciones_enemigos3[i][0] + cantidad_movimiento
                posiciones_enemigos3[i][1] = posiciones_enemigos3[i][1] - (cantidad_movimiento/16)
                if posiciones_enemigos3[i][0] >= 0.75:
    ...
    for i in range(3):
        if activos_enemigos4[i]:
            ...
            if direcciones_enemigos4[i] == 0:
                ...
                posiciones_enemigos4[i][0] = posiciones_enemigos4[i][0] + cantidad_movimiento
                posiciones_enemigos4[i][1] = posiciones_enemigos4[i][1] - (cantidad_movimiento/18)
                if posiciones_enemigos4[i][0] >= 0.75:
    ...
    for i in range(3):
        if activos_enemigos5[i]:
            ...
            if direcciones_enemigos5[i] == 0:
                ...
                posiciones_enemigos5[i][0] = posiciones_enemigos5[i][0] + cantidad_movimiento
                posiciones_enemigos5[i][1] = posiciones_enemigos5[i][1] - (cantidad_movimiento/10)
                if posiciones_enemigos5[i][0] >= 0.75:
...
def draw_nave():
    ...
    for i in range(3):
        if colisionando(posicion_nave[0],posicion_nave[1],
            ...
            vivo_bala = False
            if vivos_enemigos[i] == False:
                posiciones_enemigos[i] = [-2.0, 0.00, 0.0]
            break
        elif colisionando(posiciones_bala[0],posiciones_bala[1],
            0.01,0.01,0.01,0.01,
            posiciones_enemigos2[i][0], posiciones_enemigos2[i][1],
            0.05,0.05,0.05,0.05):
            glColor3f(0,0,0)
            vivos_enemigos2[i] = False
            vivo_bala = False
            if vivos_enemigos2[i] == False:
                posiciones_enemigos2[i] = [-2.0, 0.00, 0.0]
            break
        elif colisionando(posiciones_bala[0],posiciones_bala[1],
            0.01,0.01,0.01,0.01,
            posiciones_enemigos3[i][0], posiciones_enemigos3[i][1],
            0.05,0.05,0.05,0.05):
            glColor3f(0,0,0)
            vivos_enemigos3[i] = False
            vivo_bala = False
            if vivos_enemigos3[i] == False:
                posiciones_enemigos3[i] = [-2.0, 0.00, 0.0]
            break
        elif colisionando(posiciones_bala[0],posiciones_bala[1],
            0.01,0.01,0.01,0.01,
            posiciones_enemigos4[i][0], posiciones_enemigos4[i][1],
            0.05,0.05,0.05,0.05):
            glColor3f(0,0,0)
            vivos_enemigos4[i] = False
            vivo_bala = False
            if vivos_enemigos4[i] == False:
                posiciones_enemigos4[i] = [-2.0, 0.00, 0.0]
            break
        elif colisionando(posiciones_bala[0],posiciones_bala[1],
            0.01,0.01,0.01,0.01,
            posiciones_enemigos5[i][0], posiciones_enemigos5[i][1],
            0.05,0.05,0.05,0.05):
            glColor3f(0,0,0)
            vivos_enemigos5[i] = False
            vivo_bala = False
            if vivos_enemigos5[i] == False:
                posiciones_enemigos5[i] = [-2.0, 0.00, 0.0]
            break
